...
public class TreatmentCategoryV1 extends MotechBaseDataObject {
    ...
    public TreatmentCategoryV1() {
    }

    public TreatmentCategoryV1(String name, String code, Integer dosesPerWeek,
