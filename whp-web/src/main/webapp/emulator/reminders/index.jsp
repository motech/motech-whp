...
<head>
    <%
        ...
        if (request.getParameter("reminder-response-type") != null)
            application.setAttribute("reminder-response-type", request.getParameter("reminder-response-type"));
...
<div class="container">
    ...
    <form name="testSubmit" method="GET">
        ...
        <div class="row-fluid">
            <span style="vertical-align:top" class="pull-left span3">Set reminder response type as</span>
            <input id="response_type_success" type="radio" name="reminder-response-type" <%=success ? "checked" : ""%>
                   value="success"/> Success
            <input id="response_type_failure" type="radio" name="reminder-response-type" <%=!success ? "checked" : ""%>
    ...
    <div id="statusMessage" style="color: chocolate;">
        From now on response type "<%=success ? "Success" : "Failure"%>" will be returned as reminder response
