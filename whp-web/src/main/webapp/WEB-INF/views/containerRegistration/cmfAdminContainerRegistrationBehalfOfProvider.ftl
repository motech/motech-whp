                ...
                <div class="well">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <input id="containerId" class="span" name="${spring.status.expression}" type="text" maxlength="${containerIdMaxLength}" value="${spring.status.value?default("")}" placeholder="Enter a container ID from provider's pool"/>
                        </div>
                    </div>
                    <div class="control-group">
