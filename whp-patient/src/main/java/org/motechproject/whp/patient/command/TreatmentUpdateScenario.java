...
public enum TreatmentUpdateScenario {
    ...
    New(UpdateScope.openTreatment), Close(UpdateScope.closeTreatment), TransferredIn(UpdateScope.transferIn), Pause(UpdateScope.pauseTreatment), Restart(UpdateScope.restartTreatment);
