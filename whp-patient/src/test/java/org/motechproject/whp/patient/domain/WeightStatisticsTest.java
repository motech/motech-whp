...
public class WeightStatisticsTest {
    ...
    public void shouldUpdateCurrentWeightResultAndPushToEndOfList() {
        ...
        weightStatistics.add(new WeightStatisticsRecord(SputumTrackingInstance.PreTreatment, null, oldMeasuringDate));
        weightStatistics.add(new WeightStatisticsRecord(SputumTrackingInstance.ExtendedIP, null, oldMeasuringDate));

        LocalDate newMeasuringDate = new LocalDate(2012, 1, 1);
        WeightStatisticsRecord newWeightStatisticsRecord = new WeightStatisticsRecord(SputumTrackingInstance.ExtendedIP, null, newMeasuringDate);
    ...
    public void shouldReturnLastRecord() {
        ...
        weightStatistics.add(new WeightStatisticsRecord(SputumTrackingInstance.PreTreatment, null, new LocalDate(2010, 10, 10)));
        assertThat(weightStatistics.latestResult().getWeight_instance(), is(SputumTrackingInstance.PreTreatment));

        weightStatistics.add(new WeightStatisticsRecord(SputumTrackingInstance.EndIP, null, new LocalDate(2010, 10, 10)));
    ...
    public void shouldReturnWeightStatisticsResultForGivenSputumTrackingInstance() {
        WeightStatistics weightStatistics = new WeightStatistics();
        WeightStatisticsRecord pretreatmentWeightStatisticsRecord = new WeightStatisticsRecord(SputumTrackingInstance.PreTreatment, null, DateUtil.today());
        WeightStatisticsRecord endIpWeightStatisticsRecord = new WeightStatisticsRecord(SputumTrackingInstance.EndIP, null, DateUtil.today());
