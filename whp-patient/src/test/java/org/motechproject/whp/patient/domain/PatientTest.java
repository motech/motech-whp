...
public class PatientTest {
    ...
    public void shouldReturnIPProgressPercentage() {
        ...
        patient.setNumberOfDosesTaken(Phase.EIP, 9, currentAdherenceCaptureWeek().startDate().minusWeeks(1));
        assertThat(patient.getIPProgressPercentage(), is(91.67));
    ...
    public void shouldReturnCPProgressPercentage() {
        ...
        //(24:IP + 9:EIP) / (24:IP + 12:EIP)
        assertThat(patient.getCPProgressPercentage(), is(64.81));
    }
    ...
    @Test
    public void shouldUpdateDoseInterruptions() {
        Patient patient = new PatientBuilder().withDefaults().build();
        patient.startTherapy(newDate(2012, 3, 1));
        patient.nextPhaseName(Phase.CP);
        patient.endLatestPhase(newDate(2012, 3, 31));
        ...
        HashSet<LocalDate> adherenceDates = new HashSet<LocalDate>();
        adherenceDates.add(newDate(2012, 3, 12));
        adherenceDates.add(newDate(2012, 3, 19));
        patient.updateDoseInterruptions(adherenceDates);

        DoseInterruptions expectedDoseInterruptions = new DoseInterruptions();
        expectedDoseInterruptions.add(new DoseInterruption(newDate(2012, 3, 2)).endMissedPeriod(newDate(2012, 3, 11)));
        expectedDoseInterruptions.add(new DoseInterruption(newDate(2012, 3, 14)).endMissedPeriod(newDate(2012, 3, 18)));
        expectedDoseInterruptions.add(new DoseInterruption(newDate(2012, 3, 21)));
