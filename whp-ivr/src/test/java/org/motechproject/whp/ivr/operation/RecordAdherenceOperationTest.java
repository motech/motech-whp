...
public class RecordAdherenceOperationTest {
    ...
    public void setUp() {
        initMocks(this);
        recordAdherenceOperation = new RecordAdherenceOperation(whpAdherenceService);
    }
    ...
    public void shouldSaveAdherenceForCurrentPatient() {
        ...
        WeeklyAdherenceSummary weeklyAdherenceSummary = new WeeklyAdherenceSummary(PATIENT_2, currentWeekInstance(), 2);
